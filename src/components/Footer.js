...
export default function Footer() {
    return (
        <footer className="text-center" style={{ backgroundColor: "#808080" }}>
            <div className="container p-2">
                <section className="mb-1">
                    <a className="btn btn-link text-dark ps-5 pe-5" href="https://www.linkedin.com/in/qkeddy/" role="button" >
                    ...
                    <a className="btn btn-link text-dark ps-5 pe-5" href="https://github.com/qkeddy" role="button">
                    ...
                    <a className="btn btn-link text-dark ps-5 pe-5" href="mailto:qkeddy@gmail.com" role="button">
